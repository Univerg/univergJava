...
public class IFAvaliacoes extends JInternalFrame {
	 ...
	 * @throws Throwable 
	 */
	public IFAvaliacoes() throws Throwable {
	...
	private JImagePanel getJpRemoverAtualizar()  throws IOException{
		if (jpRemoverAtualizar == null) {
			...
			jpRemoverAtualizar.setBorder(new TitledBorder(null, "Avalia\u00E7\u00F5es", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 153, 51)));
			jpRemoverAtualizar.setBounds(19, 46, 1008, 562);
	...
	private JScrollPane getJspTabela() {
		if (jspTabela == null) {
			...
			jspTabela.setBounds(25, 24, 956, 508);
